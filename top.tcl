...
# Quartus Prime: Generate Tcl File for Nios V/m PIO Example 
...
if {$make_assignments} {
	...
	set_global_assignment -name IP_FILE s10_configuration_clock_ip.ip
	set_global_assignment -name IP_FILE reset_release.ip
	set_global_assignment -name IP_FILE issp_out_ip.ip
	set_global_assignment -name IP_FILE clock_configuration_ip.ip
